...
2
7 8
</pre></div><div class="output"><div class="title">Output<div title="Copy" data-clipboard-target="#id003313179803989861" id="id006083559617966783" class="input-output-copier">Copy</div></div><pre id="id003313179803989861">Bob
Tie
Alice
Alice
</pre></div></div></div>